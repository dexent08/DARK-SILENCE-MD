...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~eMcmhT4Y#FxPvixyMvDO7BVUVP7qt9PkiH9_TdxgmxZUSVn-92yI",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "923175734157",
    OWNER_NAME: process.env.OWNER_NAME || "➺🅥👑⃝❂͜͡D̸E̸X̸E̸N̸T̸⍣⃟❂͜͡",
    READ_CMD: process.env.READ_CMD || "true",
    BOT_NAME: process.env.BOT_NAME || "➺🅥👑⃝❂͜͡D̸E̸X̸E̸N̸T̸⍣⃟❂͜͡",
    STATUS_REPLY: process.env.STATUS_REPLY || "`➺үσυя sтαтυs sεεη נυsт ησω вү 🅥👑⃝❂͜͡D̸E̸X̸E̸N̸T̸⍣⃟❂͜͡`",
